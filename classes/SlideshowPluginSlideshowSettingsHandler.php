		...
		*/
		...
		if ($fullDefinition)
		{
			...
			$data = array(
					...
					'pauseOnHover'                => array('type' => 'radio' , 'default' => $data['pauseOnHover']               , 'description' => $descriptions['pauseOnHover']               , 'group' => __('Control', 'slideshow-jquery-image-gallery')      , 'options' => array('true' => $yes, 'false' => $no)),
